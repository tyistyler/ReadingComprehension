...
def train(args, train_dataset, model, tokenizer):
    ...
    def evaluate_model(train_preds, train_label_ids, tb_writer, args, model, tokenizer, best_steps, best_dev_acc):
        train_preds = np.argmax(train_preds, axis=1)          # [160]
        train_acc = simple_accuracy(train_preds, train_label_ids)
        # print("train_preds={}".format(train_preds))
        # print("train_preds[0]={}".format(len(train_preds[0])))
        train_preds = None
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            # print("input_ids={}".format(batch[0].size()))      # [8, 4, 256]
            # print("attention_mask={}".format(batch[1].size()))    # [8, 4, 256]
            # print("token_type_ids={}".format(batch[2].size()))    # [8, 4, 256]
            # print("labels={}".format(batch[3].size()))        # [8]
            inputs = {
                "input_ids": batch[0],
...
def main():
    ...
    if args.local_rank == -1 or args.no_cuda:
        ...
        print("args.n_gpu={}".format(args.n_gpu))
    ...
    # Prepare GLUE task
    args.task_name = args.task_name.lower()                 # reclor
